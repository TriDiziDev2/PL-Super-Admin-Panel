...
const DashboardPage = () => {
  ...
  return <div className='dashboardcontainer'>
    <div className='activityheader'>
            <h1 className='activityheadline'><span className="gradient-text">Dashboard</span></h1>
            <p className='activitydesc'>Real-time analytics and insights for your auction platform</p>
    </div>
    <div className='dashboardinsights'>
      <div className='dashinsight' onClick={() => navigate("/products")}>
        ...
        <h2>16,234</h2>
        <div className='dashgrowth'><MdArrowOutward /> +18.2% from last month</div>
      </div>
      <div className='dashinsight1'onClick={() => navigate("/users")}>
        ...
        <h2>8,956</h2>
        <div className='dashgrowth'><MdArrowOutward /> +14.8% from last month</div>
      </div>
      <div className='dashinsight2' onClick={() => navigate("/leads")}>
        ...
        <h2>1,456</h2>
        <div className='dashgrowth'><MdArrowOutward /> +26.4% from last month</div>
      </div>
      <div className='dashinsight3' onClick={() => navigate("/financials")}>
        ...
        <h2>₹2.8Cr</h2>
        <div className='dashgrowth'><MdArrowOutward /> +18.7% from last month</div>
      </div>
    </div>
    <div className='categoryperformance'>
      <div className='catperformanceheader'>
        <h2><GoDotFill className='catperformdoticon' />Category Performance</h2>
      ...
      <div className='catperfomancerow'>
        <div className='catperformer' onClick={() => navigate("/products")}>
          <div className='catperformerrow'>
            ...
            <div className='catperformerright'><FiHome /></div>
          </div>
        ...
        <div className='catperformer' onClick={() => navigate("/products")}>
          <div className='catperformerrow'>
            ...
            <div className='catperformerright1'><FaCarSide  /></div>
          </div>
        ...
        <div className='catperformer' onClick={() => navigate("/products")}>
          <div className='catperformerrow'>
            ...
            <div className='catperformerright2'><RiSofaFill  /></div>
          </div>
        ...
        <div className='catperformer' onClick={() => navigate("/products")}>
          <div className='catperformerrow'>
            ...
            <div className='catperformerright3'><FiWatch  /></div>
          </div>
      ...
      <div className='catperfomancerow'>
        <div className='catperformer' onClick={() => navigate("/products")}>
          <div className='catperformerrow'>
            ...
            <div className='catperformerright4'><PiPaintBrushBold  /></div>
          </div>
        ...
        <div className='catperformer' onClick={() => navigate("/products")}>
          <div className='catperformerrow'>
            ...
            <div className='catperformerright5'><BsBank /></div>
          </div>
        ...
        <div className='catperformer' onClick={() => navigate("/products")}>
          <div className='catperformerrow'>
            ...
            <div className='catperformerright6'><GoTrophy  /></div>
          </div>
        ...
        <div className='catperformer' onClick={() => navigate("/products")}>
          <div className='catperformerrow'>
            ...
            <div className='catperformerright7'><BsThreeDots  /></div>
          </div>
    ...
    <div className='dashactivity'>
      <div className='dashactivityhead'>
        <h2><TbActivityHeartbeat className='dashactivityicon'/>Activity Center Overview</h2>
        <p>Product approvals, advertisements, and featured listings</p>
      </div>
      <div className='dashboardrow'>
        <div className='dashactivitycont' onClick={() => navigate("/activity")}>
          <div className='dashactivityrow'>
            <p className='dashactivityicon'><IoMdTime /></p>
            <p className='dashactivitytag'>Pending</p>
          </div>
          <h2 className='dashactivitynum'>24</h2>
          <p className='dashactivitynote'>Product Approvals</p>
          <p className='dashactivityendnotes'>8 Marketplace • 10 Buy Now • 6 Auctions</p>
        </div>
        <div className='dashactivitycont1' onClick={() => navigate("/activity")}>
          <div className='dashactivityrow'>
            <p className='dashactivityicon1'><BsLightningCharge  /></p>
            <p className='dashactivitytag1'>Live</p>
          </div>
          <h2 className='dashactivitynum'>12</h2>
          <p className='dashactivitynote'>Active Ads</p>
          <p className='dashactivityendnotes1'>5 Home Top • 4 Home Bottom • 3 Product</p>
        </div>
        <div className='dashactivitycont2' onClick={() => navigate("/activity")}>
          <div className='dashactivityrow'>
            <p className='dashactivityicon2'><FaStar /></p>
          ...
          <p className='dashactivityendnotes2'>Premium listings across all modes</p>
        </div>
        <div className='dashactivitycont3' onClick={() => navigate("/activity")}>
          <div className='dashactivityrow'>
            <p className='dashactivityicon3'><FaRegCircleCheck /></p>
    ...
    <div className='financialserv'>
      <div className='dashactivityhead'>
        <h2><FaArrowTrendUp className='dashactivityicon'/>Financial Services & Packages</h2>
        <p>Quick access to subscription plans, coupons, lead unlocks, and digital media</p>
      </div>
      <div className='dashboardrow'>
        <div className='dashactivitycont' onClick={() => navigate("/financials")}>
          <div className='dashactivityrow'>
            <p className='finserv'><LuCrown  /></p>
            <p className='dashactivitytag4'>4 Plans</p>
          </div>
          <h2 className='dashactivitynum1'>Subscription Plans</h2>
          <p className='dashactivitynote'>BASIC • PREMIUM • ELITE PLUS • ENTERPRISE</p>
          <p className='dashactivityendnotes4'>Manage Plans</p>
        </div>
        <div className='dashactivitycont1' onClick={() => navigate("/financials")}>
          <div className='dashactivityrow'>
            <p className='finserv1'><RiCoupon3Line   /></p>
        ...
        <div className='dashactivitycont2' onClick={() => navigate("/financials")}>
          <div className='dashactivityrow'>
            <p className='finserv2'><LuUsers /></p>
            <p className='dashactivitytag6'>4 Packs</p>
          </div>
          <h2 className='dashactivitynum1'>Lead Unlocks</h2>
          <p className='dashactivitynote'>Basic • Extra 1 • Extra 2 • Extra 3</p>
          <p className='dashactivityendnotes6'>Manage Packages</p>
        </div>
        <div className='dashactivitycont3' onClick={() => navigate("/financials")}>
          <div className='dashactivityrow'>
            <p className='finserv3'><BsStars /></p>
            <p className='dashactivitytag7'>All-in-One</p>
          </div>
          <h2 className='dashactivitynum1'>Digital Media</h2>
          <p className='dashactivitynote'>Photo, video & social media package</p>
          <p className='dashactivityendnotes7'>View Package</p>
        </div>
      </div>
      <div className='dashboardrow'>
        <div className='finservshort' onClick={() => navigate("/financials")}>
          <div className='finserveshorticon'><IoCardOutline /></div>
          <div className='finservshortdetails'>
            <h2>₹85.6L</h2>
            <p>Subscriptions</p>
          </div>
        </div>
        <div className='finservshort1' onClick={() => navigate("/financials")}>
          <div className='finserveshorticon1'><VscPercentage  /></div>
          <div className='finservshortdetails'>
            <h2>₹12.4L</h2>
            <p>Coupon Discounts</p>
          </div>
        </div>
        <div className='finservshort2' onClick={() => navigate("/financials")}>
          <div className='finserveshorticon2'><LuUsers /></div>
          <div className='finservshortdetails'>
            <h2>₹25.9L</h2>
            <p>Lead Unlocks</p>
          </div>
        </div>
        <div className='finservshort3' onClick={() => navigate("/financials")}>
          <div className='finserveshorticon3'><BsStars  /></div>
          <div className='finservshortdetails'>
            <h2>₹60L</h2>
            <p>Digital Media</p>
          </div>
    ...
    <div className='dashboardrow'>
      <div className='lastdashinsight' onClick={() => navigate("/employees")}>
        ...
        <h2 className='lastdashinsightvalue'>163 <LuAward className='lastdashicon'/></h2>
        <p className='lastdashinsightnote'>Managing 5 business categories</p>
      </div>
      <div className='lastdashinsight1' onClick={() => navigate("/enquiries")}>
        <p className='lastdashinsighttitle'>Pending Enquiries</p>
        <h2 className='lastdashinsightvalue'>31 <GoDotFill className='lastdashicon'/></h2>
      ...
      <div className='lastdashinsight2' onClick={() => navigate("/products")}>
        ...
        <h2 className='lastdashinsightvalue'>87 <TbActivityHeartbeat className='lastdashicon'/></h2>
        <p className='lastdashinsightnote1'><MdArrowOutward /> +12 new this week</p>
      </div>
    </div>
  </div>;
};
